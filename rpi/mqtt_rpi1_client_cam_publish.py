...
port = 1883
topic = '/Group3/rpi1/camera'  # Replace with your desired topic
...
try:
    while True:
        try:
            ...
            time.sleep(0.1)  # Ensure the header is sent first
            ...
            time.sleep(0.1)  # Wait before capturing the next image
